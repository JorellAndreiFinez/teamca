...
const toDate = (value: string | Date | undefined | null): Date => new Date(value as string | Date);
...
export function formatTaskDeadlineLabel(value: string | Date | undefined | null): string {
  if (!value) {
    return 'No due';
  }
